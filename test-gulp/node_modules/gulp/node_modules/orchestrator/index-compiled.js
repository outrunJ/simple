...
var Orchestrator = function Orchestrator() {
...
Orchestrator.prototype.allDone = function () {
	var i,
	    task,
	    allDone = true; // nothing disputed it yet
...
var listenToEvent = function listenToEvent(target, event, callback) {
