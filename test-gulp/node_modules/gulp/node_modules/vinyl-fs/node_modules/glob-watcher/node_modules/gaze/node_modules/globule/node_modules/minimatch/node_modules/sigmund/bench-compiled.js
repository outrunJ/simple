...
function customWs(obj, md, d) {
  d = d || 0;
  var to = typeof obj === 'undefined' ? 'undefined' : _typeof(obj);
...
function sparseFE2(obj, maxDepth) {
  ...
  function ch(v, depth) {
    ...
    if ((typeof v === 'undefined' ? 'undefined' : _typeof(v)) !== 'object' || !v) {
      soFar += v;
      return;
    }
...
exports.compare = {
  ...
  'JSON.stringify (guarded)': function JSONStringifyGuarded() {
    ...
    return JSON.stringify(test, function (k, v) {
      if ((typeof v === 'undefined' ? 'undefined' : _typeof(v)) !== 'object' || !v) return v;
